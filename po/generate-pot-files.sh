...
xgettext ../src/app/data/org.acreetionos.MediaWriter.desktop -o desktop.pot
itstool -i as-metainfo.its -o appstream.pot ../src/app/data/org.acreetionos.MediaWriter.metainfo.xml.in
