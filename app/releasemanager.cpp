...
void ReleaseManager::fetchReleases() {
    ...
    //DownloadManager::instance()->fetchPageAsync(this, "TBD://path/to/the.json");
}
...
ReleaseListModel::ReleaseListModel(ReleaseManager *parent)
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora KDE Plasma Desktop", "A complete, modern desktop built using the KDE Plasma Desktop.", { "<p>", "The Fedora KDE Plasma Desktop Edition is a powerful Fedora-based operating system utilizing the KDE Plasma Desktop as the main user interface.", "</p><p>", "Fedora KDE Plasma Desktop comes with many pre-selected top quality applications that suit all modern desktop use cases - from online communication like web browsing, instant messaging and electronic mail correspondence, through multimedia and entertainment, to an advanced productivity suite, including office applications and enterprise grade personal information management.", "</p><p>", "All KDE applications are well integrated, with a similar look and feel and an easy to use interface, accompanied by an outstanding graphical appearance.", "</p>" }, Release::SPINS, "qrc:/icons/plasma", { "https://spins.stg.fedoraproject.org/en/kde/../static/images/screenshots/screenshot-kde.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Xfce Desktop", "A complete, well-integrated Xfce Desktop.", { "<p>", "The Fedora Xfce spin showcases the Xfce desktop, which aims to be fast and lightweight, while still being visually appealing and user friendly.", "</p><p>", "Fedora Xfce is a full-fledged desktop using the freedesktop.org standards.", "</p>"} , Release::SPINS, "qrc:/icons/xfce", { "https://spins.stg.fedoraproject.org/en/xfce/../static/images/screenshots/screenshot-xfce.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Cinnamon Desktop", "A modern desktop featuring traditional Gnome user experience.", { "<p>", "Cinnamon is a Linux desktop which provides advanced innovative features and a traditional user experience. The desktop layout is similar to Gnome 2. The underlying technology is forked from Gnome Shell. The emphasis is put on making users feel at home and providing them with an easy to use and comfortable desktop experience.", "</p><p>", "Cinnamon is a popular desktop alternative to Gnome 3 and this spin provides the option to quickly try and install this desktop.", "</p>" }, Release::SPINS, "qrc:/icons/cinnamon", { "https://spins.stg.fedoraproject.org/en/cinnamon/../static/images/screenshots/screenshot-cinnamon.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora SoaS Desktop", "Discover. Reflect. Share. Learn.", { "<p>", "Sugar on a Stick is a Fedora-based operating system featuring the award-winning Sugar Learning Platform and designed to fit on an ordinary USB thumbdrive (\"stick\").", "</p><p>", "Sugar sets aside the traditional “office-desktop” metaphor, presenting a child-friendly graphical environment. Sugar automatically saves your progress to a \"Journal\" on your stick, so teachers and parents can easily pull up \"all collaborative web browsing sessions done in the past week\" or \"papers written with Daniel and Sarah in the last 24 hours\" with a simple query rather than memorizing complex file/folder structures. Applications in Sugar are known as Activities, some of which are described below.", "</p><p>", "It is now deployable for the cost of a stick rather than a laptop; students can take their Sugar on a Stick thumbdrive to any machine - at school, at home, at a library or community center - and boot their customized computing environment without touching the host machine’s hard disk or existing system at all.", "</p>" }, Release::SPINS, "qrc:/icons/soas", { "https://spins.stg.fedoraproject.org/en/soas/../static/images/screenshots/screenshot-soas.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://dl.fedoraproject.org/pub/alt/unofficial/releases/24/x86_64/Fedora-SoaS-Live-x86_64-24-20160614.n.0.iso", "ba1dbd4bac36660f8f5b6ef9acaa18bcfb117413bc2b557b05a876778f4fa777", 732954624, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://dl.fedoraproject.org/pub/alt/unofficial/releases/24/i386/Fedora-SoaS-Live-i386-24-20160614.n.0.iso", "2af7c621681c3f4978e71a25bfd608fa66d2b441db51806b9ab639901c8eec58", 708837376, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/24/Labs/x86_64/iso/Fedora-Astronomy_KDE-Live-x86_64-24-1.2.iso", "eeb21b6801494668d2031a0c341cfd266b633ae33d7ce5cd3ea1ec308e70224a", 2477785088, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/24/Labs/i386/iso/Fedora-Astronomy_KDE-Live-i386-24-1.2.iso", "e5724016044f1f0b836d8551a10ae6e0b987552e1fa934e58d0aca3a61ab185d", 2631925760, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://dl.fedoraproject.org/pub/alt/unofficial/releases/24/x86_64/Fedora-Design_suite-Live-x86_64-24-20160614.n.0.iso", "d9a44a18e7433e8d523fa38d7c0f71199b5866af57d17f3c1e433cdd098373cd", 1932735283, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://dl.fedoraproject.org/pub/alt/unofficial/releases/24/i386/Fedora-Design_suite-Live-i386-24-20160614.n.0.iso", "77ac8c0ec235604ea2a49ad475356d243636f460410038879504fc82665c1651", 2040109465, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/x86_64/Fedora-Live-Design_suite-x86_64-23-10.iso", "beb5b9129a19d494064269d2b4be398f6724ff0128adc245d4e5414b4ea1196c", 1932735283, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/i386/Fedora-Live-Design_suite-i686-23-10.iso", "8cdc37d92a0c2322ad3789b2c9f7960311e85d0f3628b82fd530d54cf7c45110", 2040109465, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/24/Labs/x86_64/iso/Fedora-Games-Live-x86_64-24-1.2.iso", "84ebef0dfc7a15af5164ed8c40f8bd7ea4fbdf8046457f3fe7e6278d2fcd5510", 3865470566, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/x86_64/Fedora-Live-Games-x86_64-23-10.iso", "5b4a9264f176fb79e3e6de280ade23af80cda65112e8dc9cfc8c44fcd60b0eb4", 4187593113, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/i386/Fedora-Live-Games-i686-23-10.iso", "fa9d4003094e85e2f667a7a065dbd1f59903ad61a3a3154aabc0db2ebe68093a", 3972844748, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/24/Labs/x86_64/iso/Fedora-Robotics-Live-x86_64-24-1.2.iso", "fd5a0718f85499d0fe69f9c9a8fcf00eb32ec06e8b7520ddd063433a462ce6b7", 2576980377, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/x86_64/Fedora-Live-Robotics-x86_64-23-10.iso", "71008e7035cc4ac79da7166786450ac2d73df5dab2240070af8e52e81aab11ea", 2684354560, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/i386/Fedora-Live-Robotics-i686-23-10.iso", "c76a71ef18bedf07e6c41e6a26a740562121c32e32acd5200c255f3c47ada0a8", 2684354560, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/24/Labs/x86_64/iso/Fedora-Scientific_KDE-Live-x86_64-24-1.2.iso", "6cfdba696cbd69e2878f4c6f4ee5cf7852dc6b6265ddf85477c48e67822d0aeb", 3113851289, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/x86_64/Fedora-Live-Scientific_KDE-x86_64-23-10.iso", "255b73a16feb8b44cdf546338ce48a3085be858dfeccfca1df03b87ff7d57934", 2899102924, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/23/Spins/i386/Fedora-Live-Scientific_KDE-i686-23-10.iso", "72669c5fa57ab298d73cf545c88050977cdbaf8f2ee573e6146651cb4a156b53", 2791728742, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "https://download.fedoraproject.org/pub/alt/releases/24/Labs/x86_64/iso/Fedora-Security-Live-x86_64-24-1.2.iso", "522b432295b380afcaf91310672e34f23a3b2219f0209b7d3cc6d99d03959807", 1181116006, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
