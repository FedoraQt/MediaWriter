...
ReleaseListModel::ReleaseListModel(ReleaseManager *parent)
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Workstation", tr("This is the Linux workstation you've been waiting for."), { "<p>", tr("Fedora Workstation is a reliable, user-friendly, and powerful operating system for your laptop or desktop computer. It supports a wide range of developers, from hobbyists and students to professionals in corporate environments."), "</p><blockquote><p>", tr("“The plethora of tools provided by<br /> Fedora allows me to get the job done.<br /> It just works.”"), "</p><p align=right> ― <em>Christine Flood, ", tr("JVM performance engineer"), "</em></p></blockquote><h3>", tr("Sleek user interface"), "</h3><p>", tr("Focus on your code in the GNOME 3 desktop environment. GNOME is built with developer feedback and minimizes distractions, so you can concentrate on what's important."), "</p><h3>", tr("Complete open source toolbox"), "</h3><p>", tr("Skip the drag of trying to find or build the tools you need. With Fedora's complete set of open source languages, tools, and utilities, everything is a click or command line away. There's even project hosting and repositories like COPR to make your code and builds available quickly to the community."), "</p><h3>", tr("GNOME Boxes & other virt tools"), "</h3><p>", tr("Get virtual machines up and running quickly to test your code on multiple platforms using GNOME Boxes. Or dig into powerful, scriptable virtualization tools for even more control."), "</p><h3>", tr("Built-in Docker support"), "</h3><p>", tr("Containerize your own apps, or deploy containerized apps out of the box on Fedora, using the latest technology like Docker."), "</p>" }, Release::PRODUCT, "qrc:/icons/workstation", {}, {} });
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Server", tr("The latest technology. A stable foundation. Together, for your applications and services."), { "<blockquote><p>", tr("“The simplicity introduced with rolekit and cockpit have made server deployments a breeze. What took me a few days on other operating systems took less than an hour with Fedora %(rel)s Server. It just works.”"), "</p><p align=right> ― <em>Dan Mossor, ", tr("Systems Engineer"), "</em></p></blockquote><p>", tr("Fedora Server is a short-lifecycle, community-supported server operating system that enables seasoned system administrators experienced with any OS to make use of the very latest server-based technologies available in the open source community."), "</p><h3>", tr("Easy Administration"), "</h3><p>", tr("Manage your system simply with Cockpit's powerful, modern interface. View and monitor system performance and status, and deploy and manage container-based services."), "</p><h3>", tr("Server Roles"), "</h3><p>", tr("There's no need to set up your server from scratch when you use server roles. Server roles plug into your Fedora Server system, providing a well-integrated service on top of the Fedora Server platform. Deploy and manage these prepared roles simply using the Rolekit tool."), "</p><h3>", tr("Database Services"), "</h3><p>", tr("Fedora Server brings with it an enterprise-class, scalable database server powered by the open-source PostgreSQL project."), "</p><h3>", tr("Complete Enterprise Domain Solution"), "</h3><p>", tr("Level up your Linux network with advanced identity management, DNS, certificate services, Windows(TM) domain integration throughout your environment with FreeIPA, the engine that drives Fedora Server's Domain Controller role."), "</p><blockquote><p>", tr("“The Docker Role for Fedora Server was simple and fast to install so that you can run your Docker images. This makes a great testbed for beginners and experts with docker so that they can develop their applications on the fly.”"), "</p><p align=right> ― <em>John Unland, ", tr("Information Systems Student"), "</em></p></blockquote>" }, Release::PRODUCT, "qrc:/icons/server", {}, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), tr("Custom image"), tr("Pick a file from your drive(s)"), { tr("<p>Here you can choose a OS image from your hard drive to be written to your flash disk</p><p>Currently it is only supported to write raw disk images (.iso or .bin)</p>") }, Release::LOCAL, "qrc:/icons/folder", {}, {} });
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora KDE Plasma Desktop", tr("A complete, modern desktop built using the KDE Plasma Desktop."), { "<p>", tr("The Fedora KDE Plasma Desktop Edition is a powerful Fedora-based operating system utilizing the KDE Plasma Desktop as the main user interface."), "</p><p>", tr("Fedora KDE Plasma Desktop comes with many pre-selected top quality applications that suit all modern desktop use cases - from online communication like web browsing, instant messaging and electronic mail correspondence, through multimedia and entertainment, to an advanced productivity suite, including office applications and enterprise grade personal information management."), "</p><p>", tr("All KDE applications are well integrated, with a similar look and feel and an easy to use interface, accompanied by an outstanding graphical appearance."), "</p>" }, Release::SPINS, "qrc:/icons/plasma", { "http://spins.stg.fedoraproject.org/en/kde/../static/images/screenshots/screenshot-kde.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Xfce Desktop", tr("A complete, well-integrated Xfce Desktop."), { "<p>", tr("The Fedora Xfce spin showcases the Xfce desktop, which aims to be fast and lightweight, while still being visually appealing and user friendly."), "</p><p>", tr("Fedora Xfce is a full-fledged desktop using the freedesktop.org standards."), "</p>"} , Release::SPINS, "qrc:/icons/xfce", { "http://spins.stg.fedoraproject.org/en/xfce/../static/images/screenshots/screenshot-xfce.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora LXDE Desktop", tr("A light, fast, less-resource hungry desktop environment."), { "<p>", tr("LXDE, the \"Lightweight X11 Desktop Environment\", is an extremely fast, performant, and energy-saving desktop environment. It maintained by an international community of developers and comes with a beautiful interface, multi-language support, standard keyboard shortcuts and additional features like tabbed file browsing."), "</p><p>", tr("LXDE is not designed to be powerful and bloated, but to be usable and slim. A main goal of LXDE is to keep computer resource usage low. It is especially designed for computers with low hardware specifications like netbooks, mobile devices (e.g. MIDs) or older computers."), "</p>" }, Release::SPINS, "qrc:/icons/lxde", { "http://spins.stg.fedoraproject.org/en/lxde/../static/images/screenshots/screenshot-lxde.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora MATE-Compiz Desktop", tr("A classic Fedora Desktop with an additional 3D Windows Manager."), { "<p>", tr("The MATE Compiz spin bundles MATE Desktop with Compiz Fusion. MATE Desktop is a lightweight, powerful desktop designed with productivity and performance in mind. The default windows manager is Marco which is usable for all machines and VMs. Compiz Fusion is a beautiful 3D windowing manager with Emerald and GTK+ theming."), "</p><p>", tr("If you want a powerful, lightweight Fedora desktop with 3D eyecandy you should definitely try the MATE-Compiz spin."), "</p>" }, Release::SPINS, "qrc:/icons/mate", { "http://spins.stg.fedoraproject.org/en/mate-compiz/../static/images/screenshots/screenshot-matecompiz.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Cinnamon Desktop", tr("A modern desktop featuring traditional Gnome user experience."), { "<p>", tr("Cinnamon is a Linux desktop which provides advanced innovative features and a traditional user experience. The desktop layout is similar to Gnome 2. The underlying technology is forked from Gnome Shell. The emphasis is put on making users feel at home and providing them with an easy to use and comfortable desktop experience."), "</p><p>", tr("Cinnamon is a popular desktop alternative to Gnome 3 and this spin provides the option to quickly try and install this desktop."), "</p>" }, Release::SPINS, "qrc:/icons/cinnamon", { "http://spins.stg.fedoraproject.org/en/cinnamon/../static/images/screenshots/screenshot-cinnamon.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora SoaS Desktop", tr("Discover. Reflect. Share. Learn."), { "<p>", tr("Sugar on a Stick is a Fedora-based operating system featuring the award-winning Sugar Learning Platform and designed to fit on an ordinary USB thumbdrive (\"stick\")."), "</p><p>", tr("Sugar sets aside the traditional “office-desktop” metaphor, presenting a child-friendly graphical environment. Sugar automatically saves your progress to a \"Journal\" on your stick, so teachers and parents can easily pull up \"all collaborative web browsing sessions done in the past week\" or \"papers written with Daniel and Sarah in the last 24 hours\" with a simple query rather than memorizing complex file/folder structures. Applications in Sugar are known as Activities, some of which are described below."), "</p><p>", tr("It is now deployable for the cost of a stick rather than a laptop; students can take their Sugar on a Stick thumbdrive to any machine - at school, at home, at a library or community center - and boot their customized computing environment without touching the host machine’s hard disk or existing system at all."), "</p>" }, Release::SPINS, "qrc:/icons/soas", { "http://spins.stg.fedoraproject.org/en/soas/../static/images/screenshots/screenshot-soas.jpg" }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Astronomy", tr("Powerful completely open-source and free tool for amateurs and professionals."), { "<p>", tr("Fedora Astronomy brings a complete open source toolchain to both amateur and professional astronomers."), "</p><p>", tr("The Spin provides the Fedora KDE desktop enhanced with a complete scientific Python environment and the AstrOmatic software for data analysis. KStars was added to provide a full featured astrophotography tool. As KStars uses the INDI library to control equipment, various telescopes, cameras etc. are supported. Summarized, Fedora Astronomy provides a complete set of software, from the observation planning to the final results."), "</p>" }, Release::LABS, "qrc:/icons/astronomy", { }, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Games", tr("A collection and perfect show-case of the best games available in Fedora."), { "<p>", tr("The Fedora Games spin offers a perfect showcase of the best games available in Fedora. The included games span several genres, from first-person shooters to real-time and turn-based strategy games to puzzle games."), "</p><p>", tr("Not all the games available in Fedora are included on this spin, but trying out this spin will give you a fair impression of Fedora's ability to run great games."), "</p>" }, Release::LABS, "qrc:/icons/games", {}, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    ...
    m_releases.append(new Release {manager(), m_releases.length(), "Fedora Security Lab", tr("A safe test environment to work on security auditing, forensics, system rescue and teaching security testing methodologies."), { "<p>", tr("The Fedora Security Lab provides a safe test environment to work on security auditing, forensics, system rescue and teaching security testing methodologies in universities and other organizations."), "</p><p>", tr("The spin is maintained by a community of security testers and developers. It comes with the clean and fast Xfce Desktop Environment and a customized menu that provides all the instruments needed to follow a proper test path for security testing or to rescue a broken system. The Live image has been crafted to make it possible to install software while running, and if you are running it from a USB stick created with LiveUSB Creator using the overlay feature, you can install and update software and save your test results permanently."), "</p>" }, Release::LABS, "qrc:/icons/security", {}, {} });
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
...
QString Release::description() const {
    ...
    for (auto i : m_description) {
        ...
        result.append(i.replace("\%(rel)s ", "").replace("<br />", ""));
    }
    return result;
}
