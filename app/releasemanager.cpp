...
ReleaseListModel::ReleaseListModel(ReleaseManager *parent)
    ...
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Workstation/x86_64/iso/Fedora-Workstation-Live-x86_64-24-1.2.iso", "", 1503238553, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Workstation/i386/iso/Fedora-Workstation-Live-i386-24-1.2.iso", "", 1717986918, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/x86_64/iso/Fedora-KDE-Live-x86_64-24-1.2.iso", "", 1288490188, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/i386/iso/Fedora-KDE-Live-i386-24-1.2.iso", "", 1288490188, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/x86_64/iso/Fedora-Xfce-Live-x86_64-24-1.2.iso", "", 960495616, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/i386/iso/Fedora-Xfce-Live-i386-24-1.2.iso", "", 934281216, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/x86_64/iso/Fedora-LXDE-Live-x86_64-24-1.2.iso", "", 877658112, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/i386/iso/Fedora-LXDE-Live-i386-24-1.2.iso", "", 1010827264, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/x86_64/iso/Fedora-MATE_Compiz-Live-x86_64-24-1.2.iso", "", 1395864371, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/i386/iso/Fedora-MATE_Compiz-Live-i386-24-1.2.iso", "", 1288490188, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/x86_64/iso/Fedora-Cinnamon-Live-x86_64-24-1.2.iso", "", 1288490188, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/fedora/linux/releases/24/Spins/i386/iso/Fedora-Cinnamon-Live-i386-24-1.2.iso", "", 1288490188, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/x86_64/Fedora-Games-Live-x86_64-24-1.2.iso", "", 3865470566, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/i386/Fedora-Games-Live-i386-24-1.2.iso", "", 4080218931, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/x86_64/Fedora-Robotics-Live-x86_64-24-1.2.iso", "", 2576980377, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/i386/Fedora-Robotics-Live-i386-24-1.2.iso", "", 2899102924, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/x86_64/Fedora-Scientific_KDE-Live-x86_64-24-1.2.iso", "", 3113851289, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/i386/Fedora-Scientific_KDE-Live-i386-24-1.2.iso", "", 3435973836, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
    ...
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 24, {}, ReleaseVersion::FINAL, QDateTime::fromString("2016-06-21", "yyyy-MM-dd")});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/x86_64/Fedora-Security-Live-x86_64-24-1.2.iso", "", 1181116006, ReleaseArchitecture::fromId(ReleaseArchitecture::X86_64)});
    m_releases.last()->versionList().last()->addVariant(new ReleaseVariant {m_releases.last()->versionList().last(), "http://download.fedoraproject.org/pub/alt/releases/24/Spins/i386/Fedora-Security-Live-i386-24-1.2.iso", "", 1288490188, ReleaseArchitecture::fromId(ReleaseArchitecture::X86)});
    m_releases.last()->addVersion(new ReleaseVersion {m_releases.last(), 23, {}, ReleaseVersion::FINAL, QDateTime::fromString("2015-11-03", "yyyy-MM-dd")});
