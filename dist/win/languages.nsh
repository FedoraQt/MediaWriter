...
LangString VCRedistNotInstalled ${LANG_ITALIAN}              "Nel sistema non è installato Microsoft Visual C++ Redistributable.$\n$\nMicrosoft Visual C++ è necessario per eseguire correttamente ${APPNAME}.$\n$\nVuoi scaricare ed installare Visual C++ Redistributable (circa 25 MB)?"
