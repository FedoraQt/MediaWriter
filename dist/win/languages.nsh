...
LangString AdminRightsRequired ${LANG_BELARUSIAN}  "Патрабуюцца правы адміністратара."
...
LangString AdminRightsRequired ${LANG_POLISH}  "Wymagane są uprawnienia administratora."
...
LangString AdminRightsRequired ${LANG_SERBIAN}  "Администраторска права су неопходна!"
...
LangString AdminRightsRequired ${LANG_THAI}  "ต้องการสิทธิ์ของแอดมิน!"
...
LangString UninstallPreviousVersion ${LANG_BELARUSIAN}  "Выдаленне папярэдняй версіі ${APPNAME}..."
...
LangString UninstallPreviousVersion ${LANG_POLISH}  "Odinstalowywanie poprzedniej wersji programu ${APPNAME}..."
...
LangString UninstallPreviousVersion ${LANG_SERBIAN}  "Уклањање претходног издања програма ${APPNAME}..."
...
LangString UninstallPreviousVersion ${LANG_THAI}  "กำลังถอนการติดตั้งเวอร์ชั่นก่อนหน้าของ ${APPNAME}..."
...
LangString UninstallProgram ${LANG_BELARUSIAN}  "Сапраўды выдаліць ${APPNAME}?"
...
LangString UninstallProgram ${LANG_GERMAN}  "Möchten Sie ${APPNAME}? deinstallieren?"
...
LangString UninstallProgram ${LANG_POLISH}  "Odinstalować program ${APPNAME}?"
...
LangString UninstallProgram ${LANG_RUSSIAN}  "Хотите удалить ${APPNAME}?"
LangString UninstallProgram ${LANG_SERBIAN}  "Да ли желите да деинсталирате ${APPNAME}?"
...
LangString UninstallProgram ${LANG_THAI}  "คุณต้องการถอนการติดตั้ง ${APPNAME} หรือไม่?"
...
LangString VCRedistDownloadFailed ${LANG_GERMAN}  "Das Herunterladen des Visual C++ Redistributable ist fehlgeschlagen.$\n$\nBitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es erneut,$\noder laden Sie es manuell von folgender Adresse herunter:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistDownloadFailed ${LANG_POLISH}  "Pobranie Visual C++ Redistributable się nie powiodło.$\n$\nProszę sprawdzić połączenie z Internetem i spróbować ponownie$\nlub pobrać ręcznie z:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistDownloadFailed ${LANG_SERBIAN}  "Преузимање пакета „Visual C++ Redistributable“ није успело.$\n$\nПроверите вашу интернет везу и покушајте поново,$\nили га преузмите ручно са:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistDownloadFailed ${LANG_THAI}  "การดาวน์โหลด Visual C++ Redistributable ล้มเหลว$\n$\nโปรดตรวจสอบการเชื่อมต่ออินเตอร์เน็ตของคุณและลองใหม่อีกครั้ง$\nหรือดาวน์โหลดเองจาก:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistDownloading ${LANG_BELARUSIAN}  "Спампоўванне Microsoft Visual C++ Redistributable..."
...
LangString VCRedistDownloading ${LANG_POLISH}  "Pobieranie Microsoft Visual C++ Redistributable..."
...
LangString VCRedistDownloading ${LANG_SERBIAN}  "Преузимање пакета „Microsoft Visual C++ Redistributable“..."
...
LangString VCRedistDownloading ${LANG_SLOVENIAN}  "Prenašanje paketa Microsoft Visual C++ Redistributable ..."
...
LangString VCRedistDownloading ${LANG_THAI}  "กำลังดาวน์โหลด Microsoft Visual C++ Redistributable..."
...
LangString VCRedistInstalling ${LANG_BELARUSIAN}  "Усталяванне Microsoft Visual C++ Redistributable..."
...
LangString VCRedistInstalling ${LANG_POLISH}  "Instalowanie Microsoft Visual C++ Redistributable..."
...
LangString VCRedistInstalling ${LANG_SERBIAN}  "Инсталирање пакета „Microsoft Visual C++ Redistributable“..."
...
LangString VCRedistInstalling ${LANG_SLOVENIAN}  "Nameščanje paketa Microsoft Visual C++ Redistributable ..."
...
LangString VCRedistInstalling ${LANG_THAI}  "กำลังติดตั้ง Microsoft Visual C++ Redistributable..."
...
LangString VCRedistNotInstalled ${LANG_BELARUSIAN}  "У вас не ўсталяваны Microsoft Visual C++ Redistributable.$\n$\nГэты кампанент патрабуецца для працы ${APPNAME}.$\n$\nХочаце спампаваць і ўсталяваць яго? (прыблізна 25 МБ)"
...
LangString VCRedistNotInstalled ${LANG_GERMAN}  "Microsoft Visual C++ Redistributable ist nicht auf Ihrem System installiert.$\n$\nEs wird für den ordnungsgemäßen Betrieb von ${APPNAME} benötigt.$\n$\nMöchten Sie es jetzt herunterladen und installieren? (ca. 25 MB)"
...
LangString VCRedistNotInstalled ${LANG_POLISH}  "Microsoft Visual C++ Redistributable nie jest zainstalowane w systemie.$\n$\nJest ono wymagane do poprawnego działania programu ${APPNAME}.$\n$\nPobrać i zainstalować je teraz? (około 25 MB)"
...
LangString VCRedistNotInstalled ${LANG_SERBIAN}  "Пакет „Microsoft Visual C++ Redistributable“ није инсталиран на вашем систему.$\n$\nОн је неопходан да би ${APPNAME} радио исправно.$\n$\nДа ли желите да га преузмете и инсталирате сада? (приближно 25 MB)"
...
LangString VCRedistNotInstalled ${LANG_THAI}  "Microsoft Visual C++ Redistributable ยังไม่ถูกติดตั้งบนระบบของคุณ.$\n$\n${APPNAME} ต้องการมันเพื่อทำงานได้อย่างถูกต้อง.$\n$\nคุณต้องการที่ดาวน์โหลดและติดตั้งมันเลยหรือไม่? (ประมาณ 25 MB)"
...
LangString VCRedistSkipped ${LANG_BELARUSIAN}  "Вы не сталі ўсталеўваць Visual C++ Redistributable.$\n$\nБез яго ${APPNAME} можа працаваць не як мае быць.$\n$\nКампанент можна спампаваць уручную з:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistSkipped ${LANG_GERMAN}  "Sie haben sich entschieden, die Installation der Visual C++ Redistributable zu überspringen.$\n$\n${APPNAME} funktioniert ohne es möglicherweise nicht ordnungsgemäß.$\n$\nSie können es manuell hier herunterladen:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistSkipped ${LANG_HEBREW}  "בחרת לדלג על התקנת חבילת ההפצה של Visual C++.$\n$\n${APPNAME} עלול שלא לפעול כראוי בלעדיה.$\n$\nאפשר להוריד אותה בנפרד מ:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistSkipped ${LANG_POLISH}  "Wybrano pominięcie instalacji Visual C++ Redistributable.$\n$\n${APPNAME} może nie działać poprawnie bez tego.$\n$\nMożna je pobrać ręcznie z:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistSkipped ${LANG_SERBIAN}  "Изабрали сте да прескочите инсталацију пакета „Visual C++ Redistributable“.$\n$\n${APPNAME} можда неће радити исправно без њега.$\n$\nМожете га преузети ручно са:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
...
LangString VCRedistSkipped ${LANG_THAI}  "คุณได้เลือกที่จะข้ามการติดตั้งของ Visual C++ Redistributable$\n$\n${APPNAME} อาจทำงานขัดข้องหากไม่มีมัน$\n$\nคุณสามารถดาวน์โหลดเองได้จาก:$\nhttps://aka.ms/vs/17/release/vc_redist.x64.exe"
