...
!define HELPURL "https://github.com/AOSC-Dev/MediaWriter" # "Support Information" link
...
!else
    ...
    !if "${CERTPASS}" != ""
        !system 'osslsigncode sign -pkcs12 "${CERTPATH}/authenticode.pfx" -readpass "${CERTPASS}" -h sha256 -n "AOSC Media Writer" -i https://getfedora.org -t http://timestamp.comodoca.com/authenticode -in "../../build/wineprefix/drive_c/uninstall.unsigned.exe" -out "../../build/wineprefix/drive_c/uninstall.exe" ' = 0
    !else
