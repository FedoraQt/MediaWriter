 ...
 *
 * When downloading a file, the Manager asks the mirror service for a list of mirrors first.
 ...
 *
 * For files hosted on AcreetionOS servers, it also tries to get a list of mirrors to download the file from.
 */
