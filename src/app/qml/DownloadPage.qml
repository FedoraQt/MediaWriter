...
Page {
    ...
    Column {
        ...
        QQC2.Label {
            ...
            text: qsTr("Your drive will be resized to a smaller capacity. You may resize it back to normal by using AcreetionOS Media Writer. This will remove installation media from your drive.")
            width: infoColumn.width
            wrapMode: QQC2.Label.Wrap
        }
        ...
        QQC2.Label {
            ...
            text: qsTr("Your board or device is not supported by AcreetionOS Media Writer yet. Please check <a href=%1>this page</a> for more information about its compatibility with AcreetionOS and how to create bootable media for it.").arg("https://acreetionos.org/docs/architectures")
            width: infoColumn.width
            wrapMode: QQC2.Label.Wrap
        }
