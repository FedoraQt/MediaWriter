    ...
    ColumnLayout {
        ...
        Column {
            ...
            Heading {
                level: 2
                text: {
                    if (releases.variant.status == Units.DownloadStatus.Downloading || releases.variant.status === Units.DownloadStatus.Download_Verifying || releases.variant.status === Units.DownloadStatus.Stopped)
